            ...
            <table id="datatablesSimple" class="table-striped fs-6">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo e($categoria->caracteristica->descripcion); ?>

                        </td>
                        <td>
                            <?php if($categoria->caracteristica->estado == 1): ?>
                            ...
                            <div class="d-flex justify-content-around">
                                ...
                                <div>
                                    ...
                                    <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                        ...
                                        <li><a class="dropdown-item" href="<?php echo e(route('categorias.edit',['categoria'=>$categoria])); ?>">Editar</a></li>
                                        <?php endif; ?>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    ...
                                    <?php if($categoria->caracteristica->estado == 1): ?>
                                    <button title="Eliminar" data-bs-toggle="modal" data-bs-target="#confirmModal-<?php echo e($categoria->id); ?>" class="btn btn-datatable btn-icon btn-transparent-dark">
                                    ...
                                    <?php else: ?>
                                    <button title="Restaurar" data-bs-toggle="modal" data-bs-target="#confirmModal-<?php echo e($categoria->id); ?>" class="btn btn-datatable btn-icon btn-transparent-dark">
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="confirmModal-<?php echo e($categoria->id); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <?php echo e($categoria->caracteristica->estado == 1 ? '¿Seguro que quieres eliminar la categoría?' : '¿Seguro que quieres restaurar la categoría?'); ?>

                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                                    <form action="<?php echo e(route('categorias.destroy',['categoria'=>$categoria->id])); ?>" method="post">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Punto-de-Venta\resources\views/categoria/index.blade.php ENDPATH**/ ?>
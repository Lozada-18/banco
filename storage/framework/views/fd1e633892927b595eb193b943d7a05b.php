...
<div class="container-fluid px-4">
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('crear-user')): ?>
    <div class="mb-4">
            ...
            <table id="datatablesSimple" class="table table-striped fs-6">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo e($item->getRoleNames()->first()); ?>
                            ...
                            <div class="d-flex justify-content-around">
                                <div>
                                    ...
                                    <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                        <!-----Editar usuarios--->
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('editar-user')): ?>
                                        <li><a class="dropdown-item" href="<?php echo e(route('users.edit',['user'=>$item])); ?>">Editar</a></li>
                                        <?php endif; ?>
                                    </ul>
                                </div>
                                <div>
                                ...
                                <div>
                                    <!------Eliminar user---->
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('eliminar-user')): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Punto-de-Venta\resources\views/user/index.blade.php ENDPATH**/ ?>
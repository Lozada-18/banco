...
<div class="container-fluid px-4">
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('crear-presentacione')): ?>
    <div class="mb-4">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table id="datatablesSimple" class="table table-striped fs-6">
                ...
                <tbody>
                    <?php $__currentLoopData = $presentaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td>
                            ...
                            <div class="d-flex justify-content-around">
                                <div>
                                    ...
                                    <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('editar-presentacione')): ?>
                                        <li><a class="dropdown-item" href="<?php echo e(route('presentaciones.edit',['presentacione'=>$item])); ?>">Editar</a></li>
                                        <?php endif; ?>
                                    </ul>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('eliminar-presentacione')): ?>
                                    <?php if($item->caracteristica->estado == 1): ?>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <?php echo e($item->caracteristica->estado == 1 ? '¿Seguro que quieres eliminar la presentación?' : '¿Seguro que quieres restaurar la presentación?'); ?>

                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                                    <form action="<?php echo e(route('presentaciones.destroy',['presentacione'=>$item->id])); ?>" method="post">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Punto-de-Venta\resources\views/presentacione/index.blade.php ENDPATH**/ ?>
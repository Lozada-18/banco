...
<body>
    ...
    <nav class="navbar navbar-expand-md bg-body-secondary">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="<?php echo e(route('panel')); ?>">
                <img src="<?php echo e(asset('assets/img/icon.png')); ?>" alt="Logo" width="30" height="30" class="d-inline-block align-text-top">
                Sistema de venta
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="<?php echo e(route('panel')); ?>">Inicio</a>
                    </li>
                    <li class="nav-item">
    ...
    <section class="container-fluid bg-body-secondary text-center">
        <div class="container p-5">
            ...
            <div class="">
                <a href="<?php echo e(route('login')); ?>" role="button" class="btn btn-primary">Probar ahora</a>
            </div>
        </div>
...
</html><?php /**PATH C:\Users\HP\Punto-de-Venta\resources\views/welcome.blade.php ENDPATH**/ ?>
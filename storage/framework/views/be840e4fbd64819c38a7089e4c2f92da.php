                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="container" style="font-size: small;">
                                <div class="row">
                                    <span class="m-1 rounded-pill p-1 bg-secondary text-white text-center"><?php echo e($category->caracteristica->nombre); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-around">
                                <div>
                                    ...
                                    <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                        ...
                                        <li><a class="dropdown-item" href="<?php echo e(route('productos.edit',['producto' => $item])); ?>">Editar</a></li>
                                        <?php endif; ?>
                                        <!----Ver-producto--->
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ver-producto')): ?>
                                        <li>
                                            <a class="dropdown-item" role="button" data-bs-toggle="modal" data-bs-target="#verModal-<?php echo e($item->id); ?>">Ver</a>
                                        </li>
                                        <?php endif; ?>
                                    </ul>
                                </div>
                        ...
                        <div class="modal-dialog modal-dialog-scrollable">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <p><span class="fw-bolder">Descripción: </span><?php echo e($item->descripcion); ?></p>
                                        </div>
                                        <div class="col-12">
                                            <p><span class="fw-bolder">Fecha de vencimiento: </span><?php echo e($item->fecha_vencimiento=='' ? 'No tiene' : $item->fecha_vencimiento); ?></p>
                                        </div>
                                        <div class="col-12">
                                            <p><span class="fw-bolder">Stock: </span><?php echo e($item->stock); ?></p>
                                        </div>
                                        <div class="col-12">
                                            <p class="fw-bolder">Imagen:</p>
                                            <div>
                                                <?php if($item->img_path != null): ?>
                                                <img src="<?php echo e(Storage::url('public/productos/'.$item->img_path)); ?>" alt="<?php echo e($item->nombre); ?>" class="img-fluid img-thumbnail border border-4 rounded">
                                                <?php else: ?>
                                                <img src="" alt="<?php echo e($item->nombre); ?>">
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Punto-de-Venta\resources\views/producto/index.blade.php ENDPATH**/ ?>
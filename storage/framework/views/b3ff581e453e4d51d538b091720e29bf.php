                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-4">
                            <select name="producto_id" id="producto_id" class="form-control selectpicker" data-live-search="true" data-size="1" title="Busque un producto aquí">
                                ...
                                <option value="<?php echo e($item->id); ?>"><?php echo e($item->codigo.' '.$item->nombre); ?></option>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Punto-de-Venta\resources\views/compra/create.blade.php ENDPATH**/ ?>
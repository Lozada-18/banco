            ...
            <table id="datatablesSimple" class="table table-striped fs-6">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo e($item->persona->direccion); ?>

                        </td>
                        <td>
                            <p class="fw-semibold mb-1"><?php echo e($item->persona->documento->tipo_documento); ?></p>
                            <p class="text-muted mb-0"><?php echo e($item->persona->numero_documento); ?></p>
                        </td>
                        <td>
                            <?php echo e($item->persona->tipo_persona); ?>

                        </td>
                        <td>
                            <?php if($item->persona->estado == 1): ?>
                            ...
                            <div class="d-flex justify-content-around">
                                ...
                                <div>
                                    ...
                                    <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                        ...
                                        <li><a class="dropdown-item" href="<?php echo e(route('clientes.edit',['cliente'=>$item])); ?>">Editar</a></li>
                                        <?php endif; ?>
                                    </ul>
                                </div>
                                ...
                                <div> <!------Eliminar cliente---->
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('eliminar-cliente')): ?>
                                    <?php if($item->persona->estado == 1): ?>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <?php echo e($item->persona->estado == 1 ? '¿Seguro que quieres eliminar el cliente?' : '¿Seguro que quieres restaurar el cliente?'); ?>

                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                                    <form action="<?php echo e(route('clientes.destroy',['cliente'=>$item->persona->id])); ?>" method="post">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Punto-de-Venta\resources\views/cliente/index.blade.php ENDPATH**/ ?>